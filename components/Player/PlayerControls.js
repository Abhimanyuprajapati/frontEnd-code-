...
import pausebtn from '../../assets/home/pause.svg';
import nexbtn from '../../assets/home/nex.png'
import prebtn from '../../assets/home/prex.png'
import nextbtn from '../../assets/home/next.svg';
import prevbtn from '../../assets/home/prev.svg';
...
const PlayerControls = forwardRef(({
  ...
  return (
    ...
    <div style={bottomIcons} className="bottom_area">
    {Buffer ? 
      <CircularProgress />
    :
    <>
    <Image src={prevbtn} className="forward_btn"  alt="btn" width={50} height={50} onClick={onbackward}/>
    <Image src={prebtn}  alt="btn" className="forward_epi_btn" width={40} height={40} />
    {playing ? <Image src={pausebtn}  alt="btn" width={100} height={100} onClick={onPlayPause} className="play_btn"/>:<Image src={playbtn}  alt="btn" width={100} height={100} className="play_btn" onClick={onPlayPause}/>}
    <Image src={nexbtn}  alt="btn" className="backward_epi_btn" width={40}  height={40}/>
    <Image src={nextbtn}  className="backward_btn" alt="btn" width={50} height={50} onClick={onforward}/>
    </>
  }
