...
import mobile from "../../assets/loginPage/Group 67078.png";
    ...
    <>
      <section className="container-add">
        <div className="downloadImg">
           <Image src={mobile} alt="mpb" className="downloadImg3" />
        </div>
        <div className="scannerSection">
          ...
          <div className="images">
            ...
            <div>
              <a href="https://play.google.com/store/apps/details?id=com.jalva.android" target="_blank">
