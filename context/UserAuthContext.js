...
const InstallReferer=async(data)=>{
  return Access.post('/updateInstallReferer', data).then(res => {
    return res
  }).catch(err => {
    if (err.response?.code === 403) {
      logout()
...
const updateOrder=async(data)=>{
  return Access.post('/updateOrder', data).then(res => {
    return res
  }).catch(err => {
    if (err.response?.code === 403) {
      logout()
...
const confirmOrder=async(data)=>{
  return Access.post('/confirmOrder', data).then(res => {
    return res
  }).catch(err => {
    if (err.response?.code === 403) {
      logout()
...
const addToFavourite=async(data)=>{
  return Access.post('/addtoFavourite', data).then(res => {
    return res
  }).catch(err => {
    if (err.response?.code === 403) {
      console.log(err);
